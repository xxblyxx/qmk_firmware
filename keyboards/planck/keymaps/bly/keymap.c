...
enum planck_layers { _QWERTY, _COLEMAK, _DVORAK, _LOWER, _RAISE, _PLOVER, _ADJUST, _FUNCTION, _FUNCTIONMAC };
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_PGUP, KC_PIPE, KC_PGDN,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_HOME, KC_BSLS, KC_END,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
 ...
 * |      |      |      |      |      |      |      |      |   4  |   5  |  6   |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |Ctrl Z|Ctrl X|Ctrl C|Ctrl V|      |      |      |   1  |   2  |  3   |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |   0  |   .  |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_FUNCTION] = LAYOUT_planck_grid(
    ...
    _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_1,   KC_2,     KC_3,    _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_0,   KC_DOT,   _______, _______
//  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
/* FUNKMAC aka _FunctionMAC currently not used; idea was use the function plus another modifier to activate
 * ,-----------------------------------------------------------------------------------.
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_FUNCTIONMAC] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
